    ...
    <header className="bg-zinc-900 z-10 sticky top-0 left-0 right-0 flex pb-3 pt-2 px-4 justify-between items-center">
      ...
      <nav className="flex items-center space-x-4">
        ...
        <Link to={"/"}>
          <div className="flex items-center cursor-pointer">
            ...
            <img src={youtubeText} className="w-16" alt="YouTube text logo" />
          </div>
        </Link>
      </nav>
      {/* Middle side */}
      ...
      <nav className="flex items-center mr-1 space-x-3">
        <div className="flex gap-1 mr-3">
          <button
            className="w-10 h-10 hover:bg-zinc-700 transition cursor-pointer rounded-full flex items-center justify-center"
            aria-label="Upload"
          >
